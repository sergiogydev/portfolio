    ...
    >
      ...
      <div className="relative max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="bg-gradient-to-r from-brand-400 via-brand-500 to-emerald-300 bg-clip-text text-transparent text-shine">
            Python
          </span>
          ,
        ...
        >
          Soy <span className="text-zinc-900 dark:text-zinc-100 font-medium">Sergio García Yugueros</span>, Backend Developer con +4 años en sistemas reales.
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 text-sm font-medium rounded-full border border-transparent text-zinc-700 dark:text-zinc-300 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"
          >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-8 font-mono text-xs sm:text-sm text-zinc-500 dark:text-zinc-500"
        >
      ...
      <div className="relative mt-20 overflow-hidden border-y border-zinc-200/60 dark:border-white/10">
        <div className="flex gap-12 py-5 whitespace-nowrap font-mono text-sm text-zinc-500 dark:text-zinc-500 animate-marquee">
...
function TerminalCard() {
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden border rounded-2xl border-zinc-200 dark:border-white/10 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md shadow-xl">
...
> status `}
          <span className="text-brand-500">open to work<span className="caret">▍</span></span>
        </pre>
      </div>
    </motion.div>
  );
